...
return [
    ...
    */
    ...
    'cleaners' => [
        //  由于 Laravel 容器会常驻内存，所以在涉及到用户认证的时候，需要在每次请求后清除本次请求的认证状态，以免被其他用户请求冒用
    ...
    */
    ...
    'swoole' => [
         //  程序将转入后台作为守护进程运行。长时间运行的服务器端程序必须启用此项。
        ...
        // 表示一个连接如果600秒内未向服务器发送任何数据，此连接将被强制关闭 (配合 websocket 进行心跳检测)
        'heartbeat_idle_time'      => 600,
        // 表示每60秒遍历一次   (配合 websocket 进行心跳检测)
