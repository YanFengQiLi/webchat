    ...
    <div class="login">
        ...
        <div class="content">
            <form action="" name="form2">
                <mu-text-field v-model="email" label="邮箱" label-float icon="email" full-width></mu-text-field>
                <br/>
                <mu-text-field v-model="password" type="password" label="密码" label-float icon="locked"
